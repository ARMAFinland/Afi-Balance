class CfgAmmo {
	...
	class IEDUrbanBig_Remote_Ammo: PipeBombBase {
		...
		ACE_explosives_ringtones[] = {{QPATHTOF(sound\ringtone_1.ogg), 3.5}, {QPATHTOF(sound\ringtone_2.ogg), 3.7}, {QPATHTOF(sound\ringtone_3.ogg), 1.7},{QPATHTOF(sound\ringtone_4.ogg), 2.1}, {QPATHTOF(sound\ringtone_5.ogg), 3.8}, {QPATHTOF(sound\ringtone_6.ogg), 3.0}};
	};
