...
class CfgMagazines {
	...
	class AFI_IEDUrbanBig_Pressure_Mag: IEDUrbanBig_Remote_Mag { //AFI edit
		...
		ammo = "AFI_IEDUrbanBig_Pressure_Ammo";
		class ACE_Triggers : ACE_Triggers {
	...
	class AFI_IEDLandBig_Pressure_Mag: AFI_IEDUrbanBig_Pressure_Mag {
		displayName = "Big dug-in IED (Pressure plate)";
		descriptionShort="Explosive device improvised from a 122mm artillery shell. Has pressure plate.";
		ammo = "AFI_IEDLandBig_Pressure_Ammo";
	};
	...
	class AFI_IEDUrbanSmall_Pressure_Mag: IEDUrbanSmall_Remote_Mag {
		...
		ammo = "AFI_IEDUrbanSmall_Pressure_Ammo";
		class ACE_Triggers : ACE_Triggers {
			SupportedTriggers[] = {"Command","DeadmanSwitch","Cellphone", "PressurePlate"};
		};
	};
	...
	class AFI_IEDLandSmall_Pressure_Mag: IEDLandSmall_Remote_Mag {
		...
		ammo = "AFI_IEDLandSmall_Pressure_Ammo";
		class ACE_Triggers: ACE_Triggers {
			SupportedTriggers[] = {"Command","DeadmanSwitch","Cellphone", "PressurePlate"};
		};
	};
